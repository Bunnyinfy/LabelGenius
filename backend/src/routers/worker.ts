...
router.post("/payout", workerMiddleware, async (req, res) => {
    ...
    const transaction = new Transaction().add(
        SystemProgram.transfer({
            fromPubkey: new PublicKey("Ca731bcvNF2srmKMXtnimmYjnwNH472gFLJwMd8mtNdu"),
            toPubkey: new PublicKey("2vXR4a3VxPzMzLyoaF3BJLZKDHLb8L6iygswJeyk4bjv"),//worker.address
